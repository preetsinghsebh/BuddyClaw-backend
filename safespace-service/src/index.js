...
// Setup production-grade telemetry
export async function init(sharedApp = null, customToken = null, serviceName = 'safespace') {
    ...
    const WEB_TO_INTERNAL_ID = {
        ...
        'bua': 'bua',
        'chill_chacha': 'chill_chacha',
        'late_night_dadi': 'late_night_dadi',
    ...
    router.get('/api/profile/:chatId', verifyInternalToken, (req, res) => {
        ...
        const personaId = userPersonas.get(chatId) || 'listener';
    ...
    async function getCharacterResponse(personaId, userText, isNudge = false, chatId = null) {
        ...
        const systemPrompt = `PERSONA:${personaId}\nReply in ${detectedLang}. Be a supportive companion. 1-2 sentences.`;
