...
const userPersonas = new PersistentMap(User, { mode: 'mongo', service: 'openclaw' });
const userActivity = new PersistentMap(User, { mode: 'mongo', service: 'openclaw' });
const userProfiles = new PersistentMap(User, { mode: 'mongo', service: 'openclaw' }); 
const userSubscriptions = new PersistentMap(User, { mode: 'mongo', service: 'openclaw' }); 
const pendingReplies = new Map(); // Not persisted (transient)
const userMessageHistory = new PersistentMap(Chat, { mode: 'mongo', service: 'openclaw' }); 
const userChatHistory = new PersistentMap(Chat, { mode: 'mongo', service: 'openclaw' }); 
const userMemories = new PersistentMap(Memory, { mode: 'mongo', service: 'openclaw' });
const anchorMemories = new VectorMemory(Memory, { mode: 'mongo', service: 'openclaw' });
